...
// document.write('<ul>');
// for (let list0 of listOfItems){
//     document.write(`<li>${list0}</li>`);
//
// }
// document.write('</ul>');
...
//  <img src="${simpson.photo}" alt=""></img> </div>`);
// }
// document.write(`</div>`);
...
// let numbers = [1, 3, 46, 32, 8];
// let string = ['hi', 'hola', 'hello', 'aloha', 'ok'];
// let arr = [2, 7, 'key', 'hit', 3>8, 5<9];
// console.log(numbers);
// console.log(string);
// console.log(arr);
...
// let i = 0;
// while (i < 20 ) {
//     document.write(`<h1>вивести 20 h</h1>`)
//     i++;
// }

// let i = 0;
// while ( i < 20) {
//     document.write(`<h1>вивести 20h ${i}</h1>`)
//     i++;
// }
...
// let num = [2, 3, 4, 5, 6, 7, 8, 9, 1, 0];
// for (let i = 0; i < num.length; i++ ){
//     console.log(num[i])
// }

// let str = ['nfrj', 'nferjnf', 'fbhejbf', 'fnewj', 'ad', 'jrifn', 'ha', 'kj', 'wre', 'ei'];
// for (let i = 0; i < str.length; i++ ){
//     console.log(str[i])
// }

// let oll = [2, 3, 4, 5, 6, 'ha', 'kj', 'wre', 'ei', 'ad' ];
// for (let i = 0; i < oll.length; i++ ){
//     console.log(oll[i])
// }

// let tt = [2, 3, false, 5, true, 'wre',true, 'ei',false, 'ad' ];
// for (let i = 0; i < tt.length; i++ ){
//     if(typeof tt[i]==='boolean'){
//     console.log(tt[i])}
// }

// let pp = [2, 3, false, 5, true, 'wre',true, 'ei',false, 'ad' ];
// for (let i = 0; i < pp.length; i++ ){
//     if(typeof pp[i]==='string'){
//     console.log(pp[i])}
// }

// let kk = [2, 3, false, 5, true, 'wre',true, 'ei',false, 'ad' ];
